...
class PySparkLoggerBase(logging.Logger):
    def debug(self, msg: object, *args: object, **kwargs: object) -> None:
        ...
        msg : str
            The log message.
        """
        super().debug(msg, *args, extra={"kwargs": kwargs})
    ...
    def critical(self, msg: object, *args: object, **kwargs: object) -> None:
        """
        Convenience method for logging an CRITICAL in structured JSON format.
        ...
        exc_info : bool = True
            ...
            This includes the exception type, value, and traceback. Default is True.
        """
        super().critical(msg, *args, exc_info=True, extra={"kwargs": kwargs})

    fatal = critical

    def log(self, level: int, msg: object, *args: object, **kwargs: object) -> None:
        """
        Convenience method for logging in structured JSON format.
        ...
        exc_info : bool = True
            ...
            This includes the exception type, value, and traceback. Default is True.
        """
        super().log(level, msg, *args, exc_info=True, extra={"kwargs": kwargs})
