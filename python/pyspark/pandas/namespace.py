...
def merge_asof(
    ...
    >>> ps.merge_asof(left, right, on="a").sort_values("a")
        a left_val  right_val
    0   1        a          1
    1   5        b          3
    2  10        c          7

    >>> ps.merge_asof(left, right, on="a", allow_exact_matches=False).sort_values("a")
        a left_val  right_val
    0   1        a        NaN
    1   5        b        3.0
    2  10        c        7.0

    >>> ps.merge_asof(left, right, on="a", direction="forward").sort_values("a")
        a left_val  right_val
    0   1        a        1.0
    1   5        b        6.0
    2  10        c        NaN

    >>> ps.merge_asof(left, right, on="a", direction="nearest").sort_values("a")
        a left_val  right_val
    0   1        a          1
    1   5        b          6
    2  10        c          7
    ...
    ... ).sort_values(["time", "ticker", "price"]).reset_index(drop=True)  # doctest: +SKIP
                         time ticker   price  quantity     bid     ask
