...
import org.apache.spark.sql.catalyst.trees.TreePattern.{TABLE_ARGUMENT_EXPRESSION, TreePattern}
...
case class FunctionTableRelationArgumentExpression(
  ...
  final override def nodePatternsInternal: Seq[TreePattern] = Seq(TABLE_ARGUMENT_EXPRESSION)
